...
function(create_sail variant module_folder)
    ...
    add_custom_command(
        ...
        COMMAND ${sail} ${module_folder}/ModuleList.sym ${module_folder}/VersionList.sym "${CMAKE_CURRENT_BINARY_DIR}/sail_output_${variant}" ${CMAKE_C_COMPILER} 0 K "${module_folder}/game"
