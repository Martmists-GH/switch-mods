...
#    create_release(ryujinx "atmosphere/contents/${title_id}/")
#    create_release(yuzu "atmosphere/contents/${title_id}/")
endfunction()

function(has_commissions)
    if (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/commissions.cmake")
        include("${CMAKE_CURRENT_SOURCE_DIR}/commissions.cmake")
    endif ()
endfunction()
