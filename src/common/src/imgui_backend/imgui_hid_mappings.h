...
constexpr struct {
        nn::hid::KeyboardKey key;
        char ch;
} key_char_mapping[] = {
    { nn::hid::KeyboardKey::A, 'a' },
    { nn::hid::KeyboardKey::B, 'b' },
    { nn::hid::KeyboardKey::C, 'c' },
    { nn::hid::KeyboardKey::D, 'd' },
    { nn::hid::KeyboardKey::E, 'e' },
    { nn::hid::KeyboardKey::F, 'f' },
    { nn::hid::KeyboardKey::G, 'g' },
    { nn::hid::KeyboardKey::H, 'h' },
    { nn::hid::KeyboardKey::I, 'i' },
    { nn::hid::KeyboardKey::J, 'j' },
    { nn::hid::KeyboardKey::K, 'k' },
    { nn::hid::KeyboardKey::L, 'l' },
    { nn::hid::KeyboardKey::M, 'm' },
    { nn::hid::KeyboardKey::N, 'n' },
    { nn::hid::KeyboardKey::O, 'o' },
    { nn::hid::KeyboardKey::P, 'p' },
    { nn::hid::KeyboardKey::Q, 'q' },
    { nn::hid::KeyboardKey::R, 'r' },
    { nn::hid::KeyboardKey::S, 's' },
    { nn::hid::KeyboardKey::T, 't' },
    { nn::hid::KeyboardKey::U, 'u' },
    { nn::hid::KeyboardKey::V, 'v' },
    { nn::hid::KeyboardKey::W, 'w' },
    { nn::hid::KeyboardKey::X, 'x' },
    { nn::hid::KeyboardKey::Y, 'y' },
    { nn::hid::KeyboardKey::Z, 'z' },
    { nn::hid::KeyboardKey::D0, '0' },
    { nn::hid::KeyboardKey::D1, '1' },
    { nn::hid::KeyboardKey::D2, '2' },
    { nn::hid::KeyboardKey::D3, '3' },
    { nn::hid::KeyboardKey::D4, '4' },
    { nn::hid::KeyboardKey::D5, '5' },
    { nn::hid::KeyboardKey::D6, '6' },
    { nn::hid::KeyboardKey::D7, '7' },
    { nn::hid::KeyboardKey::D8, '8' },
    { nn::hid::KeyboardKey::D9, '9' },
    { nn::hid::KeyboardKey::Space, ' ' },
    { nn::hid::KeyboardKey::Minus, '-' },
    { nn::hid::KeyboardKey::Plus, '=' },
    { nn::hid::KeyboardKey::Comma, ',' },
    { nn::hid::KeyboardKey::Period, '.' },
    { nn::hid::KeyboardKey::Slash, '/' },
    { nn::hid::KeyboardKey::Backslash, '\\' },
    { nn::hid::KeyboardKey::Semicolon, ';' },
    { nn::hid::KeyboardKey::Quote, '\'' },
    { nn::hid::KeyboardKey::OpenBracket, '[' },
    { nn::hid::KeyboardKey::CloseBracket, ']' },
    { nn::hid::KeyboardKey::Backquote, '`' },
    { nn::hid::KeyboardKey::NumPad0, '0' },
    { nn::hid::KeyboardKey::NumPad1, '1' },
    { nn::hid::KeyboardKey::NumPad2, '2' },
    { nn::hid::KeyboardKey::NumPad3, '3' },
    { nn::hid::KeyboardKey::NumPad4, '4' },
    { nn::hid::KeyboardKey::NumPad5, '5' },
    { nn::hid::KeyboardKey::NumPad6, '6' },
    { nn::hid::KeyboardKey::NumPad7, '7' },
    { nn::hid::KeyboardKey::NumPad8, '8' },
    { nn::hid::KeyboardKey::NumPad9, '9' },
    { nn::hid::KeyboardKey::NumPadDot, '.' },
    { nn::hid::KeyboardKey::NumPadDivide, '/' },
    { nn::hid::KeyboardKey::NumPadMultiply, '*' },
    { nn::hid::KeyboardKey::NumPadSubtract, '-' },
    { nn::hid::KeyboardKey::NumPadAdd, '+' },
};
